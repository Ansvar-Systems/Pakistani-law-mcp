...
This document addresses privacy and confidentiality considerations when using this Tool, with particular attention to professional obligations under Pakistani bar association rules.
...
- Pakistan Bar Council (PBC — پاکستان بار کونسل) rules require strict confidentiality and data processing controls

**Safe Use Options:**
1. **General Legal Research**: Use Tool for non-client-specific queries
2. **Local npm Package**: Install `@ansvar/pakistani-law-mcp` locally — database queries stay on your machine
...
## Professional Obligations (Pakistan)

### Pakistan Bar Council Rules

Advocates in Pakistan are bound by professional confidentiality rules under the Legal Practitioners and Bar Councils Act, 1973 and associated rules, administered by the Pakistan Bar Council (PBC) and provincial bar councils.
...
- Breach of confidentiality may result in disciplinary proceedings before the PBC

### Pakistan Data Protection Considerations

Pakistan's Personal Data Protection Act (PDPA) and the Prevention of Electronic Crimes Act, 2016 impose data handling obligations. When using services that process client data:

- You are responsible as the data controller
- AI service providers (Anthropic, Vercel) may process data on your behalf
- Ensure adequate technical and organizational measures are in place
- The Personal Data Protection Authority of Pakistan oversees compliance once the PDPA is fully implemented
...
```
Example: "What does Section 420 of the Pakistan Penal Code say about cheating?"
```
...
```
Example: "What are the penalties for corruption under the National Accountability Bureau Ordinance?"
```
...
- Or use commercial legal databases (PLD, APLD) with proper data processing agreements
...
3. Client matters: Use commercial legal databases (PLD, APLD) with proper agreements
...
2. Follow Pakistan government IT security requirements
...
- **Privacy Questions**: Open issue on [GitHub](https://github.com/Ansvar-Systems/Pakistani-law-mcp/issues)
- **Anthropic Privacy**: Contact privacy@anthropic.com
- **PBC Guidance**: Consult Pakistan Bar Council ethics guidance on AI tool use
